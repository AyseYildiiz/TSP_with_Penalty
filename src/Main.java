...
public class Main {
    public static void main(String[] args) {
        ...
        /*
         * List<Integer> tour =
         * TwiceAroundTheTree.approximateTSPTour(City.distancesMatrix);
         * System.out.println(City.calculateTourCost(tour, City.distancesMatrix));
         * List<Integer> tour2 =
         * NearestNeighbour.approximateTSPTour(City.distancesMatrix);
        ...
        List<Integer> revisedTour5 = TourUtils.pruneTourWithPenalty(tour5, City.distancesMatrix);
        System.out.println(City.calculateTourCost(revisedTour5, City.distancesMatrix));

        /*
         * List<Integer> tour6 = TabuSearch.solve(tour5, City.distancesMatrix, 1000);
         * System.out.println(City.calculateTourCost(tour6, City.distancesMatrix));
         */
    }
}